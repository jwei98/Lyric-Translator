class TranslationsController < ApplicationController
  ...
  def create
    ...
    @translation.create_activity :create, owner: current_user
  end
  ...
  def update
    respond_to do |format|
      if @translation.update(translation_params)
        @translation.create_activity :update, owner: current_user
  ...
  def destroy
    @translation.create_activity :destroy, owner: current_user
    @translation.destroy
    respond_to do |format|
  ...
  private
    ...
    def translation_params
      params.require(:translation).permit(:songID, :name, :lyric, :translation, :language)
    end
end
